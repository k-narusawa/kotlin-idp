...
import com.knarusawa.idp.application.service.registerUser.RegisterUserInputData
import com.knarusawa.idp.application.service.registerUser.RegisterUserService
...
class RegisterUserController(
    ...
    fun registerUser(@ModelAttribute userForm: UserForm): String {
        val input = RegisterUserInputData(
                code = userForm.code,
                password = userForm.password,
        )
        registerUserService.execute(input)
        return "redirect:/"
    }
}